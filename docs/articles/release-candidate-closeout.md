...
- [x] Formal publication binds the same 25-package candidate to NuGet.org and GitHub Packages, with exact-byte, public-visibility, and authoritative-repository verification before Release.
...
- [ ] Public visibility and authoritative repository link for all 25 GitHub Packages pages.
