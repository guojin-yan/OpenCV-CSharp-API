...
- [x] Runtime support schema v2 classifies a 34-target package surface as 25 real, 4 compatibility-only, 4 pending, and 1 excluded, with macOS outside the matrix and Android ARM/ARM64 awaiting physical-device evidence.
- [x] The closeout records two digest-pinned lifecycle-refresh candidates, Fedora 44 and Alpine 3.23, while keeping them outside the package matrix and publication candidate until fresh Full/Mini runtime evidence passes.
...
pwsh -NoProfile -File ./scripts/Test-ReleaseChangeControlRecord.ps1 -PackageRoot <package-root> -SbomRoot <sbom-root> -OutputPath <release-change-control.json> -Created <same-factual-UTC-timestamp> -ExpectedPackageCount 26
pwsh -NoProfile -File ./scripts/Test-ReleaseChangeControlRecord.ps1 -PackageRoot <package-root> -SbomRoot <sbom-root> -OutputPath <release-change-control.json> -Created <same-factual-UTC-timestamp> -ExpectedPackageCount 26 -Check
