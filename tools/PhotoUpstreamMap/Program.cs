...
internal static class Program
{
    ...
    {
        string M(string type, params string[] fragments) => FindManaged(managed, "OpenCvSharp.Photo." + type, fragments);
        return declaration.Ordinal switch
        {
            ...
            5 => M("PhotoCv2", "System.Void FastNlMeansDenoisingMulti(OpenCvSharp.Core.Mat[]", "System.Single h=3"),
            6 => M("PhotoCv2", "System.Void FastNlMeansDenoisingMulti(OpenCvSharp.Core.Mat[]", "System.Single[] h"),
            7 => M("PhotoCv2", "System.Void FastNlMeansDenoisingColoredMulti(OpenCvSharp.Core.Mat[]"),
            ...
            36 or 38 => M("AlignExposures", "System.Void Process(OpenCvSharp.Core.Mat[] src,OpenCvSharp.Core.Mat[] dst,OpenCvSharp.Core.Mat times,OpenCvSharp.Core.Mat response)"),
            39 => M("AlignMTB", "System.Void Process(OpenCvSharp.Core.Mat[] src,OpenCvSharp.Core.Mat[] dst)"),
            40 => M("AlignMTB", "OpenCvSharp.Core.Point CalculateShift("),
            ...
            51 => M("CalibrateCRF", "System.Void Process(OpenCvSharp.Core.Mat[] src,OpenCvSharp.Core.Mat dst,OpenCvSharp.Core.Mat times)"),
            ...
            65 => M("CalibrateRobertson", "OpenCvSharp.Core.Mat GetRadiance()"),
            66 => M("CalibrateRobertson", "|method|public;static|", " Create("),
            68 or 70 or 74 or 84 => M("MergeExposures", "System.Void Process(OpenCvSharp.Core.Mat[] src,OpenCvSharp.Core.Mat dst,OpenCvSharp.Core.Mat times,OpenCvSharp.Core.Mat response)"),
            71 => M("MergeDebevec", "System.Void Process(OpenCvSharp.Core.Mat[] src,OpenCvSharp.Core.Mat dst,OpenCvSharp.Core.Mat times)"),
            72 => M("MergeDebevec", "|method|public;static|", " Create()"),
            75 => M("MergeMertens", "System.Void Process(OpenCvSharp.Core.Mat[] src,OpenCvSharp.Core.Mat dst)"),
            ...
            85 => M("MergeRobertson", "System.Void Process(OpenCvSharp.Core.Mat[] src,OpenCvSharp.Core.Mat dst,OpenCvSharp.Core.Mat times)"),
            ...
            109 => M("ColorCorrectionModel", "|method|public;static|", " Create(OpenCvSharp.Core.Mat src,OpenCvSharp.Photo.ColorCheckerType colorChecker)"),
            110 => M("ColorCorrectionModel", "|method|public;static|", " Create(OpenCvSharp.Core.Mat src,OpenCvSharp.Core.Mat colors,OpenCvSharp.Photo.ColorSpace referenceColorSpace)"),
            111 => M("ColorCorrectionModel", "|method|public;static|", " Create(OpenCvSharp.Core.Mat src,OpenCvSharp.Core.Mat colors,OpenCvSharp.Photo.ColorSpace referenceColorSpace,OpenCvSharp.Core.Mat coloredPatchesMask)"),
            ...
            115 => M("ColorCorrectionModel", "System.Void SetLinearization(OpenCvSharp.Photo.LinearizationType"),
            ...
            125 => M("ColorCorrectionModel", "OpenCvSharp.Core.Mat Compute()"),
            126 => M("ColorCorrectionModel", "OpenCvSharp.Core.Mat GetColorCorrectionMatrix()"),
            127 => M("ColorCorrectionModel", "System.Double GetLoss()"),
            128 => M("ColorCorrectionModel", "OpenCvSharp.Core.Mat GetSrcLinearRGB()"),
            129 => M("ColorCorrectionModel", "OpenCvSharp.Core.Mat GetRefLinearRGB()"),
            130 => M("ColorCorrectionModel", "OpenCvSharp.Core.Mat GetMask()"),
            131 => M("ColorCorrectionModel", "OpenCvSharp.Core.Mat GetWeights()"),
