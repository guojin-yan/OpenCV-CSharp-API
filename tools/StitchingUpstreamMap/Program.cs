...
internal static class Program
{
    ...
    private static IEnumerable<string> ManagedEvidence(int ordinal, string[] managed)
    {
        string[] fragments = ordinal switch
        {
            ...
            16 => M("Stitcher|method|public;instance|", "EstimateTransform(OpenCvSharp.Core.Mat[] images,OpenCvSharp.Core.Mat[]? masks)"),
            17 => M("Stitcher|method|public;instance|", "ComposePanorama(OpenCvSharp.Core.Mat pano)"),
            18 => M("Stitcher|method|public;instance|", "ComposePanorama(OpenCvSharp.Core.Mat[] images"),
            19 => M("Stitcher|method|public;instance|", "Stitch(OpenCvSharp.Core.Mat[] images,OpenCvSharp.Core.Mat pano)"),
