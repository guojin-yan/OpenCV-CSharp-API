#!/usr/bin/env python3
"""Extract OpenCV ImgCodecs declarations with OpenCV's own hdr_parser.py."""
...
def main():
    ...
    header = opencv_root / "modules/imgcodecs/include/opencv2/imgcodecs.hpp"
    ...
    result = {
        "schemaVersion": 1,
        "generator": "tools/ImgCodecsUpstreamMap/extract_imgcodecs.py",
    ...
    print(
        "IMGCODECS_UPSTREAM_EXTRACTION_OK declarations={} enums={} classes={} callables={}".format(
            len(declarations),
