#!/usr/bin/env python3
"""Extract the OpenCV 5.0.0 ObjDetect public compatibility include closure."""
...
def main():
    ...
    umbrella = root / "modules/objdetect/include/opencv2/objdetect.hpp"
    legacy_compatibility = root / "modules/objdetect/include/opencv2/objdetect/objdetect.hpp"
    relative_headers = [
        ...
        "modules/objdetect/include/opencv2/objdetect/mcc_checker_detector.hpp",
    ...
    if len(identities) != len(set(identities)):
        ...
        raise RuntimeError(
            "ObjDetect parser closure contains duplicate identities: "
            + ", ".join(duplicates)
        )

    result = {
        "schemaVersion": 1,
        "generator": "tools/ObjDetectUpstreamMap/extract_objdetect.py",
        ...
        "compatibilityHeaders": [
            {
                ...
                "includes": "ObjDetect public declarations and owned public headers",
            },
            {
                "path": rel(legacy_compatibility, workspace),
                "sha256": sha256(legacy_compatibility),
                "includes": "opencv2/objdetect.hpp",
            },
        ],
    ...
    print(
        "OBJDETECT_UPSTREAM_EXTRACTION_OK declarations={} enums={} classes={} callables={} headers={}".format(
            len(declarations),
