...
{
    /// <summary>
    /// Represents a two-dimensional double-precision size compatible with OpenCV's <c>cv::Size2d</c>.
    /// 表示与 OpenCV <c>cv::Size2d</c> 对应的二维双精度浮点尺寸。
    /// </summary>
