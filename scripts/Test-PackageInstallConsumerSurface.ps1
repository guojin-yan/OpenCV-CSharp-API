...
Assert-Contains -Violations $violations -Path $contributingPath -Text $contributingText -Needle "fixed-major project names must not appear in consumer-facing files" -Issue "CONTRIBUTING must reject unpublished fixed-major consumer names"
