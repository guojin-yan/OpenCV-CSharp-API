param(
    ...
    [string]$HostedRunner = "",
    [string]$RunnerImage = "",
    [string]$RunnerImageVersion = "",
    [string]$HostedDistro = "",
    [string]$HostedDistroVersion = "",
    [string]$HostedArchitecture = "",
    ...
    [string]$HostedOsBuildNumber = "",
    [string]$HostedProcessArchitecture = "",
    ...
    [string]$WindowsTargetExecutionEvidence = "",
    [string]$ElfAuditEvidence = "",
    [string]$OpenCvCpuConfiguration = "",
    [string]$ExcludedForeignToolDirectories = "",
    [string]$OpenCvAsmConfiguration = "",
    [string]$NativeWrapperSources = "",
    [string]$NativeWrapperSourceCount = "",
    [string]$NativeAbiFunctionCount = "",
    ...
    [string]$ContainerPackageArchitecture = "",
