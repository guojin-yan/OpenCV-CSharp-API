...
$guards = @(
    ...
    [pscustomobject]@{
        Name = "Lifecycle refresh runtime matrix"
        Script = Join-Path $repo "scripts/Test-LifecycleRefreshRuntimeMatrix.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
        Name = "Lifecycle refresh candidate producer surface"
        Script = Join-Path $repo "scripts/Test-LifecycleRefreshCandidateProducerSurface.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
        Name = "Lifecycle refresh candidate package surface"
        Script = Join-Path $repo "scripts/Test-LifecycleRefreshCandidatePackageSurface.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
        Name = "Generic Linux RID feasibility contract"
        Script = Join-Path $repo "scripts/Test-GenericLinuxFeasibilityContract.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
        Name = "Generic Linux preview matrix"
        Script = Join-Path $repo "scripts/Test-GenericLinuxPreviewMatrix.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
        Name = "Generic Linux preview package surface"
        Script = Join-Path $repo "scripts/Test-GenericLinuxPreviewPackageSurface.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
    ...
    [pscustomobject]@{
        Name = "Headless runtime profile contract"
        Script = Join-Path $repo "scripts/Test-HeadlessRuntimeProfileContract.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
    ...
    [pscustomobject]@{
        Name = "Domestic platform certification matrix"
        Script = Join-Path $repo "scripts/Test-DomesticPlatformCertificationMatrix.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
    ...
    [pscustomobject]@{
        Name = "Capabilities JSON contract"
        Script = Join-Path $repo "scripts/Test-CapabilitiesJsonContract.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
    ...
    [pscustomobject]@{
        Name = "NativeAOT trim single-file smoke"
        Script = Join-Path $repo "scripts/Test-NativeAotSmoke.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
    ...
    [pscustomobject]@{
        Name = "DNN diagnostics contract"
        Script = Join-Path $repo "scripts/Test-DnnDiagnosticsContract.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
        Name = "Image format policy"
        Script = Join-Path $repo "scripts/Test-ImageFormatPolicy.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
    ...
    [pscustomobject]@{
        Name = "Platform probe sample"
        Script = Join-Path $repo "scripts/Test-PlatformProbeSample.ps1"
        Arguments = @("-RepositoryRoot", $repo)
    },
    [pscustomobject]@{
