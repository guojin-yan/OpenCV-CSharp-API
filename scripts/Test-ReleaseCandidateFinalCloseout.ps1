...
function Test-Record {
    ...
    Assert-True -List $List -Condition ($Record.ApiAbiBaseline.StitchingUpstreamMap.Sha256 -eq "b531f712752503b41dc8dd5138d1fa6cf154529bb7f67b20c9cafb6ef0fa17f0" -and $Record.ApiAbiBaseline.StitchingUpstreamMap.RawSha256 -eq "e712d4faed827e0c3e35ed584cde22fe11c60a9ca7589c3d87f6b840321399ad" -and $Record.ApiAbiBaseline.StitchingUpstreamMap.DeclarationCount -eq 207 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.CallableCount -eq 158 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.ImplementedCount -eq 100 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.MissingCount -eq 58 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.IntentionallyOmittedCount -eq 0 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.UnsupportedCount -eq 0 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.UpstreamConditionalCount -eq 0 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.HighLevelDeclarationCount -eq 24 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.HighLevelCallableCount -eq 21 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.HighLevelImplementedCount -eq 21 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.PublicWarperDeclarationCount -eq 12 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.PublicWarperCallableCount -eq 10 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.PublicWarperImplementedCount -eq 10 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.BlenderDeclarationCount -eq 28 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.BlenderCallableCount -eq 24 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.BlenderImplementedCount -eq 24 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.ExposureDeclarationCount -eq 53 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.ExposureCallableCount -eq 45 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.ExposureImplementedCount -eq 45 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.SourceHeaderCount -eq 14 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.CompatibilityHeaderCount -eq 14 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.SourceReviewedExtensionCount -eq 3 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.SelectedFamilyCount -eq 3 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.SelectedDeclarationCount -eq 79 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.ManagedPublicTypeAdditionCount -eq 13 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.ManagedPublicMemberAdditionCount -eq 60 -and $Record.ApiAbiBaseline.StitchingUpstreamMap.NativeEntrypointAdditionCount -eq 52 -and -not [bool]$Record.ApiAbiBaseline.StitchingUpstreamMap.UMatExecutionClaimed -and -not [bool]$Record.ApiAbiBaseline.StitchingUpstreamMap.DetailRowsMixedIntoHighLevel -and -not [bool]$Record.ApiAbiBaseline.StitchingUpstreamMap.RepositoryWideParityClaimed) -Issue "Final closeout Stitching upstream-map evidence drifted"
