...
function Test-Record {
    ...
    $stitchingEvidenceMatches =
        $Record.ApiAbiBaseline.StitchingUpstreamMap.Sha256 -eq "747062a832c2407d099dd39a8373a61cbd61005d69a8c08044c812b255a3d8ff" -and
        ...
        $Record.ApiAbiBaseline.StitchingUpstreamMap.ImplementedCount -eq 114 -and
        $Record.ApiAbiBaseline.StitchingUpstreamMap.MissingCount -eq 42 -and
        ...
        $Record.ApiAbiBaseline.StitchingUpstreamMap.SelectedFamilyCount -eq 4 -and
        $Record.ApiAbiBaseline.StitchingUpstreamMap.SelectedDeclarationCount -eq 93 -and
        $Record.ApiAbiBaseline.StitchingUpstreamMap.ManagedPublicTypeAdditionCount -eq 6 -and
        $Record.ApiAbiBaseline.StitchingUpstreamMap.ManagedPublicMemberAdditionCount -eq 31 -and
        $Record.ApiAbiBaseline.StitchingUpstreamMap.NativeEntrypointAdditionCount -eq 28 -and
