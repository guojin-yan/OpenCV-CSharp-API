...
function Test-Record {
    ...
    Assert-True -List $List -Condition ($Record.ApiAbiBaseline.Managed.Sha256 -eq "0ff64cfdd535e2d2b68e4ec6245df6979acf544a1a1b97b824480cbf23853e82" -and $Record.ApiAbiBaseline.Managed.TypeCount -eq 645 -and $Record.ApiAbiBaseline.Managed.MemberCount -eq 6985 -and $Record.ApiAbiBaseline.Managed.NamespaceCount -eq 41 -and $Record.ApiAbiBaseline.Managed.TargetFramework -eq "net8.0") -Issue "Final closeout managed API baseline evidence drifted"
