...
Assert-Contains -Violations $violations -Path $packManagedPath -Text $packManagedText -Needle '-p:NoWarn=PKV006' -Issue "Stable managed packaging must document the .NET SDK dropped-framework diagnostic boundary"
