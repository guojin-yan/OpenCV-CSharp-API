...
if ($summary.declarationCount -ne 241 -or $summary.callableCount -ne 208 -or $summary.classCount -ne 13 -or $summary.enumCount -ne 20 -or
    ...
    $summary.classificationCounts.implemented -ne 119 -or $summary.classificationCounts.missing -ne 89 -or
    $summary.classificationCounts.'non-callable-metadata' -ne 33 -or $summary.classificationCounts.'intentionally-omitted' -ne 0 -or
    $summary.selectedFamilyCount -ne 1 -or $summary.selectedDeclarationCount -ne 32 -or $summary.sourceReviewedExtensionCount -ne 1 -or
    $summary.negativeFixtureCount -ne 17 -or $summary.managedPublicTypeAdditionCount -ne 4 -or
    $summary.managedPublicMemberAdditionCount -ne 39 -or $summary.nativeEntrypointAdditionCount -ne 14) {
