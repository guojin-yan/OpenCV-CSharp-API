...
if ($summary.declarationCount -ne 241 -or $summary.callableCount -ne 208 -or $summary.classCount -ne 13 -or $summary.enumCount -ne 20 -or
    ...
    $summary.classificationCounts.implemented -ne 157 -or $summary.classificationCounts.missing -ne 51 -or
    $summary.classificationCounts.'non-callable-metadata' -ne 33 -or $summary.classificationCounts.'intentionally-omitted' -ne 0 -or
    $summary.selectedFamilyCount -ne 2 -or $summary.selectedDeclarationCount -ne 70 -or $summary.sourceReviewedExtensionCount -ne 2 -or
    $summary.negativeFixtureCount -ne 17 -or $summary.managedPublicTypeAdditionCount -ne 9 -or
    $summary.managedPublicMemberAdditionCount -ne 78 -or $summary.nativeEntrypointAdditionCount -ne 37) {
