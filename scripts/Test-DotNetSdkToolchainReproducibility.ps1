...
if ($totalSetupCount -ne 29 -or $totalDotnetVersionDeclarationCount -ne 29) {
    Add-Violation `
        -Violations $violations `
        -Path ".github/workflows" `
        -Issue "Repository workflow SDK setup surface must remain exactly 29 bound blocks" `
