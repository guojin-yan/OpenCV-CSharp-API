...
foreach ($expectation in @(
        ...
        @($workflowPath, $workflowText, 'UBUNTU_22_04_X64_RUNTIME_INPUT_PROVENANCE_OK profile=mini files=$expectedPayloadFileCount modules=$expectedModuleCount sources=9 abi_functions=526 synthetic=false', "Pack runtime job must validate exact Ubuntu 22.04 x64 mini producer provenance"),
        ...
        @($workflowPath, $workflowText, 'DEBIAN_12_X64_RUNTIME_INPUT_PROVENANCE_OK profile=mini files=$expectedPayloadFileCount modules=$expectedModuleCount sources=9 abi_functions=526 synthetic=false', "Pack runtime job must validate the exact Debian 12 x64 mini producer provenance"),
        ...
        @($workflowPath, $workflowText, 'FEDORA_40_X64_RUNTIME_INPUT_PROVENANCE_OK profile=mini files=$expectedPayloadFileCount modules=$expectedModuleCount sources=9 abi_functions=526 synthetic=false', "Pack runtime job must validate the exact Fedora 40 x64 mini producer provenance"),
        ...
        @($workflowPath, $workflowText, 'ROCKY_9_X64_RUNTIME_INPUT_PROVENANCE_OK profile=mini files=$expectedPayloadFileCount modules=$expectedModuleCount sources=9 abi_functions=526 synthetic=false extra_cmake_args=empty', "Pack runtime job must validate exact Rocky 9 x64 mini producer provenance"),
        ...
        @($workflowPath, $workflowText, 'RHEL_9_X64_RUNTIME_INPUT_PROVENANCE_OK profile=mini files=$expectedPayloadFileCount modules=$expectedModuleCount sources=9 abi_functions=526 synthetic=false extra_cmake_args=empty', "Pack runtime job must validate exact RHEL 9 x64 mini producer provenance"),
