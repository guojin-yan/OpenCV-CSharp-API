...
foreach ($expectation in @(
        ...
        @($workflowPath, $workflowText, "WINDOWS_X86_RUNTIME_INPUT_PROVENANCE_OK profile=full files=18 modules=16 sources=49 abi_functions=2545 synthetic=false machine=I386 wow64=true", "Pack runtime job must validate exact Windows x86 full provenance"),
