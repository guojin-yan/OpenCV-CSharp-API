...
foreach ($expectation in @(
        ...
        @($workflowPath, $debianJobText, "10.0.302", "Debian verification must install exact .NET 10 SDK 10.0.302"),
        ...
        @($workflowPath, $fedoraJobText, "10.0.302", "Fedora verification must install exact .NET 10 SDK 10.0.302"),
        ...
        @($workflowPath, $rockyJobText, "10.0.302", "Rocky verification must install exact .NET 10 SDK 10.0.302"),
        ...
        @($workflowPath, $rhelJobText, "10.0.302", "RHEL verification must install exact .NET 10 SDK 10.0.302"),
