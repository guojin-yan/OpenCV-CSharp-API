...
Debian ARM64 mini 已从 synthetic-only 列表中移出：`runtime-input-debian.12-arm64-mini` 已在固定 Debian 12 ARM64 容器中完成真实 producer、non-synthetic pack 与同 run consumer 验证；Windows x86 与 Alpine mini 仍保持 synthetic-only。
