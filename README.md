...
- Checked compatibility baselines covering 644 public managed types, 6,961 public/protected members, 41 namespaces under `JYPPX.OpenCvSharp`, and the declared native ABI.
