...
Ubuntu 22.04 x64 mini、Debian 12 ARM64 mini 与 Alpine 3.20 x64 mini 均已从 synthetic-only 列表中移出并完成独立真实闭环；Windows x86、Debian 12 x64 mini、Fedora 40 mini、Rocky Linux 9 mini 与 RHEL 9 mini 仍保持 synthetic-only，直到各自平台边界被独立证明。
