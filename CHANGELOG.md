...
## [5.0.0-preview.2] - Unreleased / 待发布
...
- Details / 详细说明: [`docs/releases/5.0.0-preview.2.md`](docs/releases/5.0.0-preview.2.md)
...
[5.0.0-preview.2]: https://github.com/guojin-yan/OpenCV-CSharp-API/releases
